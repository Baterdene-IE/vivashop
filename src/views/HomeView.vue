    ...
    <header id = "header" class = "vh-100 carousel slide" data-bs-ride = "carousel" style = "padding-top: 104px;">
        <div class = "container h-100 d-flex align-items-center carousel-inner">
            <div class = "text-center carousel-item active">
                ...
                <h1 class = "text-uppercase py-2 fw-bold text-white">шинээр ирсэн</h1>
                <a href = "#" class = "btn mt-3 text-uppercase">худалдаж авах</a>
            </div>
            <div class = "text-center carousel-item">
                <h2 class = "text-capitalize text-white">best price & offer</h2>
                <h1 class = "text-uppercase py-2 fw-bold text-white">шинэ улирлын</h1>
                <a href = "#" class = "btn mt-3 text-uppercase">худалдаж авах</a>
            </div>
        </div>
    ...
    <section id = "collection" class = "py-5">
        <div class = "container">
            <div class = "title text-center">
                <h2 class = "position-relative d-inline-block">Шинэ Коллекц</h2>
            </div>

            <div class = "row g-0">
                <div class = "d-flex flex-wrap justify-content-center mt-5 filter-button-group">
                    <button type = "button" class = "btn m-2 text-dark active-filter-btn" data-filter = "*">Бүгд</button>
                    <button type = "button" class = "btn m-2 text-dark" data-filter = ".best">Best Sellers</button>
                    <button type = "button" class = "btn m-2 text-dark" data-filter = ".feat">Онцлох</button>
                    <button type = "button" class = "btn m-2 text-dark" data-filter = ".new">Шинээр ирсэн</button>
                </div>
            ...
            <div class = "row g-3">
                <div class = "card border-0 col-md-6 col-lg-4 bg-transparent my-3">
                    ...
                    <div class = "card-body px-0">
                        <h4 class = "card-title">Картаар гүйлгээ хийж болдог боллоо</h4>
                        <p class = "card-text mt-3 text-muted">Бүх банкны карт ашиглан худалдан авалт хийж болдог боллоо.</p>
                        <p class = "card-text">
                            <small class = "text-muted">
                                <span class = "fw-bold">Нийтлэсэн: </span>Батболд Батбаатар
                            </small>
                        </p>
                        <a href = "#" class = "btn">цааш унших</a>
                    </div>
                </div>
